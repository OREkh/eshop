...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6-impl","es3");$.wa=$.ui?$.extend(!0,$.wa,$.ui):{};
...
$(document).ajaxSend(function(a,b,c){"POST"==c.type&&(a=(a=document.cookie.match(/(?:^|; )_csrf=([^;]*)/))?decodeURIComponent(a[1]):"",null===c.data&&(c.data=""),"string"==typeof c.data?-1==c.data.indexOf("_csrf=")&&(c.data+=(0<c.data.length?"&":"")+"_csrf="+a,b.setRequestHeader("Content-type","application/x-www-form-urlencoded")):"object"==typeof c.data&&(c.data._csrf=a))});
...
(function(a,b){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e={},f=a.fn.position,n=a.fn.offset;a.fn.position=function(b){if(!b||!b.of)return f.apply(this,arguments);b=a.extend({},b);var g=a(b.of),r=g[0],l=(b.collision||"flip").split(" "),m=b.offset?b.offset.split(" "):[0,0],p,q,h;return 9===r.nodeType?(p=g.width(),q=g.height(),h={top:0,left:0}):r.setTimeout?(p=g.width(),q=g.height(),h={top:g.scrollTop(),left:g.scrollLeft()}):r.preventDefault?(b.at="left top",p=q=0,h={top:b.of.pageY,
left:b.of.pageX}):(p=g.outerWidth(),q=g.outerHeight(),h=g.offset()),a.each(["my","at"],function(){var a=(b[this]||"").split(" ");1===a.length&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";b[this]=a}),1===l.length&&(l[1]=l[0]),m[0]=parseInt(m[0],10)||0,1===m.length&&(m[1]=m[0]),m[1]=parseInt(m[1],10)||0,"right"===b.at[0]?h.left+=p:"center"===b.at[0]&&(h.left+=p/2),"bottom"===b.at[1]?h.top+=
q:"center"===b.at[1]&&(h.top+=q/2),h.left+=m[0],h.top+=m[1],this.each(function(){var c=a(this),d=c.outerWidth(),g=c.outerHeight(),r=parseInt(a.curCSS(this,"marginLeft",!0))||0,t=parseInt(a.curCSS(this,"marginTop",!0))||0,f=d+r+(parseInt(a.curCSS(this,"marginRight",!0))||0),n=g+t+(parseInt(a.curCSS(this,"marginBottom",!0))||0),k=a.extend({},h),u;"right"===b.my[0]?k.left-=d:"center"===b.my[0]&&(k.left-=d/2);"bottom"===b.my[1]?k.top-=g:"center"===b.my[1]&&(k.top-=g/2);e.fractions||(k.left=Math.round(k.left),
k.top=Math.round(k.top));u={left:k.left-r,top:k.top-t};a.each(["left","top"],function(c,e){a.ui.position[l[c]]&&a.ui.position[l[c]][e](k,{targetWidth:p,targetHeight:q,elemWidth:d,elemHeight:g,collisionPosition:u,collisionWidth:f,collisionHeight:n,offset:m,my:b.my,at:b.at})});a.fn.bgiframe&&c.bgiframe();c.offset(a.extend(k,{using:b.using}))})};a.ui.position={fit:{left:function(b,c){var d=a(window),d=c.collisionPosition.left+c.collisionWidth-d.width()-d.scrollLeft();b.left=0<d?b.left-d:Math.max(b.left-
c.collisionPosition.left,b.left)},top:function(b,c){var d=a(window),d=c.collisionPosition.top+c.collisionHeight-d.height()-d.scrollTop();b.top=0<d?b.top-d:Math.max(b.top-c.collisionPosition.top,b.top)}},flip:{left:function(b,c){if("center"!==c.at[0]){var d=a(window),d=c.collisionPosition.left+c.collisionWidth-d.width()-d.scrollLeft(),e="left"===c.my[0]?-c.elemWidth:"right"===c.my[0]?c.elemWidth:0,g="left"===c.at[0]?c.targetWidth:-c.targetWidth,l=-2*c.offset[0];b.left+=0>c.collisionPosition.left?e+
g+l:0<d?e+g+l:0}},top:function(b,c){if("center"!==c.at[1]){var d=a(window),d=c.collisionPosition.top+c.collisionHeight-d.height()-d.scrollTop(),e="top"===c.my[1]?-c.elemHeight:"bottom"===c.my[1]?c.elemHeight:0,g="top"===c.at[1]?c.targetHeight:-c.targetHeight,l=-2*c.offset[1];b.top+=0>c.collisionPosition.top?e+g+l:0<d?e+g+l:0}}}};a.offset.setOffset||(a.offset.setOffset=function(b,c){/static/.test(a.curCSS(b,"position"))&&(b.style.position="relative");var d=a(b),e=d.offset(),g=parseInt(a.curCSS(b,"top",
!0),10)||0,l=parseInt(a.curCSS(b,"left",!0),10)||0,e={top:c.top-e.top+g,left:c.left-e.left+l};"using"in c?c.using.call(b,e):d.css(e)},a.fn.offset=function(b){var c=this[0];return c&&c.ownerDocument?b?a.isFunction(b)?this.each(function(c){a(this).offset(b.call(this,c,a(this).offset()))}):this.each(function(){a.offset.setOffset(this,b)}):n.call(this):null});a.curCSS||(a.curCSS=a.css);(function(){var b=document.getElementsByTagName("body")[0],c=document.createElement("div"),d,f;d=document.createElement(b?
"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};b&&a.extend(f,{position:"absolute",left:"-1000px",top:"-1000px"});for(var m in f)d.style[m]=f[m];d.appendChild(c);f=b||document.documentElement;f.insertBefore(d,f.firstChild);c.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";c=a(c).offset(function(a,b){return b}).offset();d.innerHTML="";f.removeChild(d);b=c.top+c.left+(b?2E3:0);e.fractions=21<b&&22>b})()})(jQuery);
